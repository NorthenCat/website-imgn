...
?>
<div class="container">
	<h2 class="text-white" style="text-align: center;margin-top: 10px;width: 100%;background-color: #212529;">DETAIL</h2>
	<?php 
	...
	$detail = $ambil -> fetch_assoc();
		//cek id akun
	$id_akun_pembeli= $detail['id_akun'];
	$id_akun_login = $_SESSION['akun']['id_akun'];
	if ($id_akun_pembeli!==$id_akun_login) {
		echo "<script>alert('Error !');window.location='index.php?page=history';</script>";
	}
	...
	<?php if ($detail['status_pembelian']=='pending') { ?>
		<div class="row">
		<div class="col-md-7">
			<div class="alert alert-info" style="padding-bottom: 0px;">
				<p>Please pay  Rp. <?php echo number_format($detail['total_pembelian']); ?> to <br><strong>BANK MANDIRI 1250010396752 A.N. Angelina Maharani</strong><br>Confirm your payment to<br>
					<strong>Whatsapp : 085156950595 (ADMIN)</strong></p>
				</div>
			</div>
		</div>
	</div>
